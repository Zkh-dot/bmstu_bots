...
end_result_command = "/result_is_done"
...
ask_for_result = f"Пожалуйста, напишите резульат теста. Если вы ввели все результаты, введите команду {end_test_command}"
ask_for_result_param = f"Пожалуйста, напишите, какой параметр нужно иметь для получения этого варианта. Пишите строго в формате \"__$параметр $минимум $максимум__\"\nЕсли вы напишете в другом формате, тест скорее всего придется переделывать."
